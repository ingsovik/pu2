...
import WeekIssues, {isActiveInMonth, isActiveOnDay} from './weekIssues'

test('Snapshot weekIssues', () =>{
    const fakeData:[{ startDay: any, startMonth: any, endDay: any, endMonth: any }] = [{startDay: 1, startMonth: 9, endDay: 0, endMonth: 0}]
    fakeData.push({startDay: 3, startMonth: 9, endDay: 6, endMonth: 9})
    fakeData.push({startDay: 8, startMonth: 10, endDay: 29, endMonth: 10})
    const tree = renderer.create(<WeekIssues preData={fakeData}/>)
